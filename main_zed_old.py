...
def main():
    ...
    while running:
        if zed.grab() == sl.ERROR_CODE.SUCCESS:
            ...
            # Clip max distance of 5.0 for visualization
            _, depth_viz = cv2.threshold(cv_depth_map, 5.0, 5.0, cv2.THRESH_TRUNC)
            ...
            if args.visualize:
                ...
                for (x, y), depth in zip(depth_points, depth_values):
                    ...
                    cv2.putText(depth_viz, depth_str, (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2, cv2.LINE_AA)
